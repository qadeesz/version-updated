...
$myUpdateChecker = Puc_v4_Factory::buildUpdateChecker(
	'https://www.seerox.com/srx_plugin_version/version.json',
	__FILE__ , //Full path to the main plugin file or functions.php.
	'table-colum-restriction'
);
